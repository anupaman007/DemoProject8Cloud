...
class Test_022_ReportDelete:
    ...
    def test_ReportDelete(self, setup):
        self.logger.info("************ Starting Test_022_ReportDelete Test *************")
        self.driver = setup
        ...
        time.sleep(5)
        self.RP.clickDeleteNo()

        self.logger.info("*************** Download button clicked Successfully **************")
        self.logger.info("************ Completed Test_022_ReportDelete Test *************")
