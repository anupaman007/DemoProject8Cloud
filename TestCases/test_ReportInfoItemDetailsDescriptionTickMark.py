...
class Test_016_ReportInfoItemDetailsDescription:
    ...
    def test_ReportDescriptionEntry(self, setup):
        self.logger.info("************ Starting Test_016_ReportInfoItemDetailsDescription *************")
        self.driver = setup
        ...
        self.RP.clickOnTickMark()

        self.logger.info("*************** Data Entered Is Saved In Description Field Successfully **************")
        self.logger.info("************ Complete Test_016_ReportInfoItemDetailsDescription *************")
