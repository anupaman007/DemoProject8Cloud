...
class Test_011_SearchUserByFirstname:
    ...
    def test_searchUserByFirstname(self, setup):
        self.logger.info("*********** Test_011_SearchUserByFirstname ************")
        self.driver = setup
        ...
        self.logger.info("***************  Search User By Firstname **************")
        ...
        self.driver.implicitly_wait(30)
        searchuser.setFirstname("Anupama")
        time.sleep(5)
        status = searchuser.searchUserByFName("Anupama")
        time.sleep(5)
        assert True == status
        self.logger.info("********************  Test_011_SearchUserByFirstname Finished **********************")
